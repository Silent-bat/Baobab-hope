                  ...
                  {navigation.map((item, index) => (
                    <div key={item.name} className="border-b border-gray-100 last:border-b-0 pb-3 last:pb-0">
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <Link
                            ...
                            className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-red-50 hover:text-red-600 transition-all duration-200 group"
                          >
                      ...
                      {item.dropdown && activeDropdown === item.name && (
                        <div className="ml-4 mt-2 space-y-2 bg-gray-50 rounded-xl p-3">
                          {item.dropdown.map((subItem) => (
                            <Link
                              key={subItem.name}
                              href={localizeHref(subItem.href)}
                              onClick={closeMenu}
                              className="flex items-center space-x-3 px-3 py-2 hover:bg-white rounded-xl transition-all duration-200 group"
                            >
                              <span className="text-lg group-hover:scale-110 transition-transform">{subItem.icon}</span>
                              <div className="flex flex-col">
